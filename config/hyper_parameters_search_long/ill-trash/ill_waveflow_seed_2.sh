        ...
        do
            ...
            do
                ...
                do
                    ...
                    EXP_DIR="log_dir/illness_ltsf/${DATASET}_ltsf_h${hid}_b${base}_o${ori}_le${l}_seed_${seed}_gpu_${DEVICE}"
                    ...
                    python run.py --config config/ltsf/ettm2/tsflow_cond_ms.yaml \
                        --seed_everything "$seed" \
                        --data.data_manager.init_args.path datasets \
                        --trainer.default_root_dir "$EXP_DIR" \
                        --data.data_manager.init_args.split_val true \
                        --data.data_manager.init_args.dataset "$DATASET" \
                        --data.data_manager.init_args.context_length 36 \
                        --data.data_manager.init_args.prediction_length 36 \
