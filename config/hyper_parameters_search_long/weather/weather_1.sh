        ...
        do
            ...
            do
                ...
                do
                    ...
                    EXP_DIR="log_dir/weather-l/${DATASET}_ltsf_h${hid}_b${base}_o${ori}_le${l}_seed_${seed}_gpu_${DEVICE}"
                    ...
                    python run.py --config config/ltsf/weather_ltsf/tsflow_cond_ms.yaml \
