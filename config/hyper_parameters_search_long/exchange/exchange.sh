        ...
        do
            ...
            do
                ...
                do
                    ...
                    EXP_DIR="log_dir/exchange_lstf/${DATASET}_ltsf_h${hid}_b${base}_o${ori}_le${l}_seed_${seed}_gpu_${seed}"
                    ...
                    python run.py --config config/ltsf/exchange_ltsf/tsflow_cond_ms.yaml \
