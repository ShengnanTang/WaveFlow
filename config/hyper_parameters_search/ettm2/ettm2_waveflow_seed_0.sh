        ...
        do
            ...
            do
                ...
                do
                    ...
                    EXP_DIR="log_dir/ettm2-s-batch_size_32/${DATASET}_stsf_h${hid}_b${base}_o${ori}_le${l}_seed_${seed}_gpu_${DEVICE}"
                    ...
                    python run.py --config config/stsf/ettm2/tsflow_cond_ms.yaml \
