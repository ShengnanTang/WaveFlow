...
# 1. 定义超参数搜索空间
BASE_PATCH_SIZES=(8 6 4)
ORI_PATCH_SIZES=(8 6 4)
HIDDEN_DIM=(64)
WAVELET_LEVEL=(1 2)
    ...
    do
        ...
        do
            ...
            do
                ...
                EXP_DIR="log_dir/${DATASET}_h${hid}_b${base}_o${ori}_le${l}_seed_${FLAG}_gpu_${FLAG}"
                ...
                python run.py --config config/stsf/solar/tsflow_cond_ms.yaml \
                    --seed_everything "$FLAG" \
                    --data.data_manager.init_args.path datasets \
                    --trainer.default_root_dir "$EXP_DIR" \
                    --data.data_manager.init_args.split_val true \
                    --data.data_manager.init_args.dataset "$DATASET" \
                    --data.data_manager.init_args.context_length 24 \
                    --data.data_manager.init_args.prediction_length 24 \
